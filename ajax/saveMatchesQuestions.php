...
if(isset($_GET['id_match']) && isset($GET['id_question']) && isset($GET['walk'])){
     ...
     $query = mysqli_query($connection, "INSERT INTO matches_questions(id, id_match, id_question, walk) VALUES(null, '{$id_match}', '{$id_question}', '{$walk}')");
